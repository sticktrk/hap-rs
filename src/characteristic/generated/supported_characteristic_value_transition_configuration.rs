...
use crate::{
    characteristic::{
        AsyncCharacteristicCallbacks, Characteristic, CharacteristicCallbacks, Format,
        HapCharacteristic, HapCharacteristicSetup, HapType, OnReadFn, OnReadFuture, OnUpdateFn,
        OnUpdateFuture, Perm, Unit,
    },
    pointer, Result,
};
...
pub struct SupportedCharacteristicValueTransitionConfigurationCharacteristic(
...
impl CharacteristicCallbacks<Vec<u8>>
    for SupportedCharacteristicValueTransitionConfigurationCharacteristic
{
...
impl AsyncCharacteristicCallbacks<Vec<u8>>
    for SupportedCharacteristicValueTransitionConfigurationCharacteristic
{
