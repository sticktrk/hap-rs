...
use crate::{
    characteristic::{
        ...
        model::ModelCharacteristic, name::NameCharacteristic,
        product_data::ProductDataCharacteristic, serial_number::SerialNumberCharacteristic,
...
impl AccessoryInformationService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            accessory_flags: Some(AccessoryFlagsCharacteristic::new(
                id + 1 + 0 + 5,
                accessory_id,
            )),
            ...
            configured_name: Some(ConfiguredNameCharacteristic::new(
                id + 1 + 2 + 5,
                accessory_id,
            )),
            matter_firmware_revision_number: Some(MatterFirmwareRevisionNumberCharacteristic::new(
                id + 1 + 3 + 5,
                accessory_id,
            )),
            ...
            hardware_finish: Some(HardwareFinishCharacteristic::new(
                id + 1 + 5 + 5,
                accessory_id,
            )),
