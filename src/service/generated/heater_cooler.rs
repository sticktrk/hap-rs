...
impl HeaterCoolerService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            current_heater_cooler_state: CurrentHeaterCoolerStateCharacteristic::new(
                id + 1 + 1,
                accessory_id,
            ),
            target_heater_cooler_state: TargetHeaterCoolerStateCharacteristic::new(
                id + 1 + 2,
                accessory_id,
            ),
            ...
            temperature_display_units: Some(TemperatureDisplayUnitsCharacteristic::new(
                id + 1 + 6 + 4,
                accessory_id,
            )),
            ..Default::default()
