...
use crate::{
    characteristic::{
        ...
        wan_status_list::WanStatusListCharacteristic, HapCharacteristic,
    },
    service::HapService,
    HapType,
};
...
impl WiFiRouterService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            managed_network_enable: ManagedNetworkEnableCharacteristic::new(
                id + 1 + 1,
                accessory_id,
            ),
            ...
            network_client_control: NetworkClientControlCharacteristic::new(
                id + 1 + 3,
                accessory_id,
            ),
            network_client_status_control: NetworkClientStatusControlCharacteristic::new(
                id + 1 + 4,
                accessory_id,
            ),
            router_status: RouterStatusCharacteristic::new(id + 1 + 5, accessory_id),
            supported_router_configuration: SupportedRouterConfigurationCharacteristic::new(
                id + 1 + 6,
                accessory_id,
            ),
            wan_configuration_list: WanConfigurationListCharacteristic::new(
                id + 1 + 7,
                accessory_id,
            ),
