...
impl ThreadTransportService {
    ...
    pub fn new(id: u64, accessory_id: u64) -> Self {
        Self {
            ...
            thread_node_capabilities: ThreadNodeCapabilitiesCharacteristic::new(
                id + 1 + 2,
                accessory_id,
            ),
            ...
            mac_transmission_counters: Some(MacTransmissionCountersCharacteristic::new(
                id + 1 + 5 + 4,
                accessory_id,
            )),
            receiver_sensitivity: Some(ReceiverSensitivityCharacteristic::new(
                id + 1 + 6 + 4,
                accessory_id,
            )),
            received_signal_strength_indication: Some(
                ReceivedSignalStrengthIndicationCharacteristic::new(id + 1 + 7 + 4, accessory_id),
            ),
            signal_to_noise_ratio: Some(SignalToNoiseRatioCharacteristic::new(
                id + 1 + 8 + 4,
                accessory_id,
            )),
            thread_openthread_version: Some(ThreadOpenthreadVersionCharacteristic::new(
                id + 1 + 9 + 4,
                accessory_id,
            )),
            transmit_power: Some(TransmitPowerCharacteristic::new(
                id + 1 + 10 + 4,
                accessory_id,
            )),
            maximum_transmit_power: Some(MaximumTransmitPowerCharacteristic::new(
                id + 1 + 11 + 4,
                accessory_id,
            )),
            ..Default::default()
