...
use crate::{
    ...
    service::{
        ...
        carbon_monoxide_sensor::CarbonMonoxideSensorService, HapService,
    },
    HapType, Result,
};
...
impl CarbonMonoxideSensorAccessory {
    ...
    pub fn new(id: u64, information: AccessoryInformation) -> Result<Self> {
        ...
        let mut carbon_monoxide_sensor =
            CarbonMonoxideSensorService::new(1 + carbon_monoxide_sensor_id + 1, id);
