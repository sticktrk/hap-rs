...
impl ToString for HapType {
    fn to_string(&self) -> String {
        match self {
            ...
            HapType::ConnectionHealthMonitor => "273".into(),
            ...
            HapType::FirmwareUpdateProtocolList => "26F".into(),
            ...
            HapType::MediaAccessControlLevel => "EE".into(),
...
impl FromStr for HapType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match s {
            ...
            "273" => Ok(HapType::ConnectionHealthMonitor),
            ...
            "26F" => Ok(HapType::FirmwareUpdateProtocolList),
            ...
            "EE" => Ok(HapType::MediaAccessControlLevel),
